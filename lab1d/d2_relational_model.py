def generate_relational_model_sql() -> str:
    return """
...
def save_sql_file(filename: str = "d2_relational_model.sql") -> None:
    sql = generate_relational_model_sql()
...
if __name__ == "__main__":
    print(generate_relational_model_sql())
    save_sql_file()
